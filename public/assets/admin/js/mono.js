...
$(document).ready(function () {
  ...
  $("#sidebar-menu > li").click(function(){
    ...
    const isSubmenu = listClass.contains("has-sub");
    const isActive = listClass.contains("active");
    $("#sidebar-menu > li").removeClass("active", "expand");
    if(!isSubmenu){
      listClass.add("active");
      return;
    }
    const isExpand = listClass.contains("expand");
    if(!isActive && isExpand){
      listClass.add("active");
    }
  });
  /*======== 4. SIDEBAR TOGGLE FOR MOBILE ========*/
