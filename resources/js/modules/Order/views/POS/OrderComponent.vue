                ...
                <div class="w-100" id="cart">
                                    ...
                                    <td>
                                        <div class="media align-items-center gap-10">
                                            ...
                                            <div class="media-body">
                                                <h5 class="text-hover-primary mb-0">Test Produ...</h5>
                                                <small></small>
                    ...
                    <div class="pos-data-table p-3">
                        <dl class="row">
                            ...
                            <dd class="col-6 text-right">37.00$</dd>

                            <dt class="col-6">Giảm giá: </dt>
                            <dd class="col-6 text-right">- 0.00$</dd>

                            <dt class="col-6">Phí ship :</dt>
                            <dd class="col-6 text-right"> 0.00$</dd>

                            <dt class="col-6 border-top font-weight-bold pt-2">Tổng tiền: </dt>
                            <dd class="col-6 text-right border-top font-weight-bold pt-2">37.00$</dd>
                        </dl>
                            ...
                            <div class="pt-4 mb-4">
                                ...
                                <ul class="list-unstyled option-buttons">
                                    ...
                                    <li id="card_payment_li">
                                        <input type="radio" id="VNPAY" value="1" v-model="form.payment_method" name="payment-method" hidden>
                                        <label for="VNPAY" class="btn btn-bordered px-4 mb-0">VNPAY</label>
                                    </li>
                                </ul>
                            </div>
