<template>
    <PageHeaderTitleComponent header-title="Cập nhật khách hàng">
        <router-link :to="{ name: 'customers' }" class="btn btn-primary text-nowrap">
    ...
    <div class="col-12">
        <form>
            ...
            <div class="d-flex justify-content-end gap-3 mt-4">
                <button type="reset" class="btn btn-secondary" @click="getCustomer">Đặt lại</button>
...
async function submitForm(){
    try {
        const response = await customerApi.updateCustomer(route.params.id ,form);
    } catch (error) {
