...
class SettingDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ["group" => "company", "key" => "latitude", "value" => "20.9987198"],
            ["group" => "company", "key" => "longitude", "value" => "105.8229152"],
            ["group" => "company", "key" => "zoom", "value" => "17"],
            ["group" => "company", "key" => "logo", "value" => "/storage/setup/logo.png"],
            ["group" => "company", "key" => "fav_icon", "value" => "/storage/setup/logo.png"],
            ...
            ["group" => "social_media", "key" => "zalo", "value" => "https://zalo.me/0919677164"],
            ["group" => "social_media", "key" => "facebook", "value" => "https://fb.com/tiembanhkemviet"],
            ["group" => "social_media", "key" => "messager", "value" => "https://m.me/tiembanhkemviet"],
            ["group" => "social_media", "key" => "instagram", "value" => null],
            ["group" => "social_media", "key" => "twitter", "value" => null],
